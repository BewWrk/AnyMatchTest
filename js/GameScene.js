...
export class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('spriteItems', 'assets/images/Items.png', { frameWidth: 88, frameHeight: 88 });
    ...
    create() {
        ...
        for (var row = 0; row < rowNum; row++) {
            for (var col = 0; col < 9; col++) {
                ...
                var sprite = this.add.sprite(18 + (col * 88), 260 + (row * 88), 'spriteItems', randomNum).setOrigin(0,0).setInteractive();
                var Item = new Object();
                Item.sprite = sprite;
        ...
        var spriteBack= this.add.sprite(36,24, 'backButton').setOrigin(0,0).setInteractive();
        ...
        var menuSprite= this.add.sprite(44,1386, 'menuButton').setOrigin(0,0).setInteractive();
